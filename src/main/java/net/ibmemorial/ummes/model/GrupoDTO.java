...
public class GrupoDTO implements Serializable, IsSerializable {
	...
	public void setQuantidadeInscritos(int qtdeInscritos) {
		setVagasDisponiveis(this.facilitador.getCodigo().equals(this.hospedeiro.getCodigo())
				? this.grupo.getQuantidadeMaxima().intValue() - qtdeInscritos - 1
				: this.grupo.getQuantidadeMaxima().intValue() - qtdeInscritos - 2);
	}
}
